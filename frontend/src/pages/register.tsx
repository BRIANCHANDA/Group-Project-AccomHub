  ...
  const handleSubmit = async (e: any) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        ...
        alertDiv.innerHTML = '<strong>Success!</strong> Account created successfully. Redirecting...';
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-md-8 col-lg-6">
              ...
              <div className="text-center mb-4">
                <h1 className="h3 fw-bold mb-2 text-dark">Create Your Account</h1>
                <p className="text-muted mb-0">Join PlacesForLeaners to find your perfect student accommodation</p>
              </div>
                ...
                <div className="card-body p-4">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row g-3">
                      ...
                      <div className="col-md-6">
                        <label className="form-label fw-medium">Phone Number (Optional)</label>
                        <input
                          type="tel"
                          name="phoneNumber"
                        ...
                        <div className="form-text">Enter 10-12 digits (with or without country code)</div>
                      </div>
                        ...
                        {formData.password && (
                          <div className="mt-2">
                            ...
                            <div className="d-flex justify-content-between mt-1">
                              <small style={{ color: getPasswordStrengthInfo().color }}>
                              ...
                              <div className="mt-2 p-2 bg-light rounded">
                                ...
                                <ul className="mb-0 mt-1" style={{ fontSize: '0.8rem' }}>
                                  {passwordStrength.feedback.map((feedback, index) => (
                                    <li key={index} className="text-danger">{feedback}</li>
                                  ))}
                                </ul>
                              </div>
                            )}
                    ...
                    <div className="mt-3 text-center">
                      ...
                      <button type="button" className="btn btn-link p-0" onClick={() => handleNavigation('signin')}>
                        Sign in here
                      </button>
                    </div>
                  </form>
                  ...
                  <div className="col-4">
                    <div className="card text-center border-0 bg-light h-100">
                      <div className="card-body py-3">
                        <div className="text-primary fw-bold">300+</div>
              ...
              <div className="row g-3">
                <div className="col-6 text-center">
                  ...
                  <div className="d-flex flex-column">
                    ...
                    <a href="#" className="text-decoration-none text-white-50 small mb-1" onClick={() => handleNavigation('signin')}>Sign In</a>
                  </div>
                </div>
                <div className="col-6 text-center">
