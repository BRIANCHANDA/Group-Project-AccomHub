  ...
  const filteredListings = useMemo(() => {
    let filtered = propertiesData.filter(listing => {
      ...
      if (typeFilter !== 'all' && listing.type !== typeFilter) return false;
       if (universityFilter !== 'all' && listing.targetUniversity !== universityFilter) return false;
...
<div className="filter-card mb-4">
  <div className="row g-2 align-items-center">
    {/* Search Input */}
    <div className={isMobile ? "col-12 mb-2" : "col-12 col-md-6 col-lg-2"}>
      <input
        type="text"
        className="form-control"
    ...
    <div className={isMobile ? "col-6" : "col-12 col-md-6 col-lg-2"}>
    ...
    <div className={isMobile ? "col-6" : "col-12 col-md-6 col-lg-2"}>
      <div className="dropdown">
        ...
        >
          <i className="bi bi-building me-1"></i>
          {universityFilter === 'all' ? 'All Universities' : 
           universityFilter.length > 15 ? universityFilter.substring(0, 15) + '...' : universityFilter}
        </button>
        <ul className="dropdown-menu" aria-labelledby="universityFilterDropdown">
          <li>
            <a
              className="dropdown-item"
              href="#"
              onClick={(e) => handleDropdownItemClick(e, () => setUniversityFilter('all'))}
            >
              All Universities
            </a>
          </li>
          <li>
            <a
              className="dropdown-item"
              href="#"
              onClick={(e) => handleDropdownItemClick(e, () => setUniversityFilter('University of Zambia'))}
            >
          ...
          <li>
            <a
              className="dropdown-item"
              href="#"
              onClick={(e) => handleDropdownItemClick(e, () => setUniversityFilter('Copperbelt University'))}
            >
          ...
          <li>
            <a
              className="dropdown-item"
              href="#"
              onClick={(e) => handleDropdownItemClick(e, () => setUniversityFilter('Mulungushi University'))}
            >
          ...
          <li>
            <a
              className="dropdown-item"
              href="#"
              onClick={(e) => handleDropdownItemClick(e, () => setUniversityFilter('Cavendish University'))}
            >
          ...
          <li>
            <a
              className="dropdown-item"
              href="#"
              onClick={(e) => handleDropdownItemClick(e, () => setUniversityFilter('Kwame Nkrumah University'))}
            >
    ...
    {/* View Controls and Items Per Page */}
    <div className="col-12 col-md-6 col-lg-4 d-flex align-items-center justify-content-end">
  ...
  {!isMobile && universityFilter !== 'all' && ` • University: ${universityFilter}`}
  ...
  onClick={() => {
    setTypeFilter('all');
    setPriceFilter('all');
    setUniversityFilter('all'); // Add this line
    setSearchTerm('');
